function startClassification()
{
    ...
    classifier=ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/V6jZT7v5o/model.json', modelReady);
}
...
function gotResults(error,results)
{
    ...
    else
    {
        ...
        else if (results[0].label=="Celular")
        {
            img.src='aliens-01.png';
            img.src='aliens-02.png';
